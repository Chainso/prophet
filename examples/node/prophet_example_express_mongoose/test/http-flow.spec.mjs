...
describe('Prophet Express Mongoose HTTP flow', function () {
  this.timeout(30_000);
  ...
  before(async function () {
    if (!process.env.MONGO_URL) {
      ...
      process.env.MONGO_URL = `${mongoServer.getUri()}prophet_example_mongoose_test`;
    }
  ...
  it('supports create -> approve -> ship -> get -> query', async function () {

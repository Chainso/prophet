...
class NodeTargetTests(unittest.TestCase):
    ...
    def test_node_prisma_stack_generates_expected_artifacts(self) -> None:
        ...
        self.assertIn('state String @default("created") @map("__prophet_state")', outputs["gen/node-express/prisma/schema.prisma"])
        self.assertIn("model OrderStateHistory", outputs["gen/node-express/prisma/schema.prisma"])
        self.assertTrue(
        ...
        self.assertIn("TransitionServices", outputs["gen/node-express/src/generated/index.ts"])
    ...
    def test_node_typeorm_stack_generates_expected_artifacts(self) -> None:
        ...
        self.assertIn("state!: string", outputs["gen/node-express/src/generated/typeorm-entities.ts"])
        self.assertIn("OrderStateHistoryEntity", outputs["gen/node-express/src/generated/typeorm-entities.ts"])
    ...
    def test_node_mongoose_stack_generates_expected_artifacts(self) -> None:
        ...
        self.assertIn("__prophet_state", outputs["gen/node-express/src/generated/mongoose-models.ts"])
        self.assertIn("OrderStateHistoryModel", outputs["gen/node-express/src/generated/mongoose-models.ts"])
        self.assertIn("applyTransition", outputs["gen/node-express/src/generated/mongoose-adapters.ts"])

...
STACK_MANIFEST_DOCUMENT: Dict[str, Any] = {
    ...
    "stacks": [
        ...
        },
        {
            ...
            "capabilities": ["action_endpoints", "typed_query_filters", "pagination", "object_refs", "nested_lists", "structs", "extension_hooks", "autodetect"],
            "default_targets": ["sql", "openapi", "python", "fastapi", "sqlalchemy", "manifest"],
            "notes": "Async-first FastAPI routes with SQLAlchemy-backed repository adapters.",
        },
        {
            ...
            "orm": "sqlmodel",
            "status": "implemented",
            "description": "Python + FastAPI stack with SQLModel persistence generation.",
            "capabilities": ["action_endpoints", "typed_query_filters", "pagination", "object_refs", "nested_lists", "structs", "extension_hooks", "autodetect"],
            "default_targets": ["sql", "openapi", "python", "fastapi", "sqlmodel", "manifest"],
            "notes": "Async-first FastAPI routes with SQLModel-backed repository adapters.",
        },
        {
            ...
            "capabilities": ["action_endpoints", "typed_query_filters", "pagination", "object_refs", "nested_lists", "structs", "extension_hooks", "autodetect"],
            "default_targets": ["sql", "openapi", "python", "flask", "sqlalchemy", "manifest"],
            "notes": "Flask blueprint generation with SQLAlchemy repositories.",
        },
        {
            ...
            "orm": "sqlmodel",
            "status": "implemented",
            "description": "Python + Flask stack with SQLModel persistence generation.",
            "capabilities": ["action_endpoints", "typed_query_filters", "pagination", "object_refs", "nested_lists", "structs", "extension_hooks", "autodetect"],
            "default_targets": ["sql", "openapi", "python", "flask", "sqlmodel", "manifest"],
            "notes": "Flask blueprint generation with SQLModel repositories.",
        },
        {
            ...
            "capabilities": ["action_endpoints", "typed_query_filters", "pagination", "object_refs", "nested_lists", "structs", "extension_hooks", "autodetect"],
            "default_targets": ["sql", "openapi", "python", "django", "django_orm", "manifest"],
            "notes": "Django views/urls generation with Django ORM scaffolding.",
        },
    ],
}

...
def _ts_scalar_type_for_descriptor(
...
def _typeorm_column_type_for_descriptor(
    type_desc: Dict[str, Any],
    type_by_id: Dict[str, Dict[str, Any]],
    enum_by_id: Dict[str, Dict[str, Any]],
) -> str:
        ...
        for field in list(obj.get("fields", [])):
            ...
            if kind == "object_ref":
                ...
                for target_pk in target_pk_fields:
                    ...
                    fk_type = _typeorm_column_type_for_descriptor(fk_desc, type_by_id, enum_by_id)
                    fk_ts_type = _ts_scalar_type_for_descriptor(fk_desc, type_by_id, enum_by_id)
            ...
            col_type = _typeorm_column_type_for_descriptor(type_desc, type_by_id, enum_by_id)
            ts_type = _ts_scalar_type_for_descriptor(type_desc, type_by_id, enum_by_id)

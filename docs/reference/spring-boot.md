...
- Stateful objects use the declared enum field directly.
...
- generated default action services publish produced events; emitted envelopes normalize embedded objects back to refs and include extracted snapshots in `updatedObjects`.

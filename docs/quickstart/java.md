...
Generated event payload ref fields use sealed `<Object>RefOrObject` contracts; for produced events, envelopes normalize embedded objects back to refs and include extracted snapshots in `updatedObjects`.

...
For produced events, event payload ref fields can be passed as either refs or full objects; emitted envelopes normalize payload refs and include extracted snapshots in `updated_objects`.
